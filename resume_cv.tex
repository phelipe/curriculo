...
\documentclass[16pt, a4paper]{awesome-cv} % A4 paper size by default, use 'letterpaper' for US letter
...
\mobile{(85) 9 97060054}

\email{phelipewesleydeoliveira@gmail.com}
%\homepage{www.posquit0.com}
\github{phelipe}
\gitlab{phelipe}
\linkedin{phelipew-oliveira}
\lattes{0855415672732784}


\position{Pesquisador e Desenvolvedor} % Your expertise/fields
\extrainfo{ Idiomas: Português (Nativo)- Inglês (Intermediário)}


\makecvfooter{}{Phelipe Wesley}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
